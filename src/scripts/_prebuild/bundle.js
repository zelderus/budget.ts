...
(function (ActionTypes) {
    ...
    ActionTypes[ActionTypes["ADD_ITEM"] = 10] = "ADD_ITEM";
    ActionTypes[ActionTypes["DELETE_ITEM"] = 11] = "DELETE_ITEM";
...
Object.defineProperty(exports, "__esModule", { value: true });
var BaseStore_1 = __webpack_require__(19);
var ActionTypes_1 = __webpack_require__(5);
/**
...
var AppStore = (function (_super) {
    ...
    //
    AppStore.prototype.getLogText = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var AppDesc_1 = __webpack_require__(13);
var MainAppWidget_1 = __webpack_require__(15);
var Dispatcher_1 = __webpack_require__(6);
var AppStore_1 = __webpack_require__(8);
/**
 * Приложение.
 */
var ZeApp = (function () {
     ...
     */
    ZeApp.prototype.getStores = function () {
        return [AppStore_1.default];
    };
    ZeApp.prototype.start = function () {
        // инициализируем диспетчера
        Dispatcher_1.default.initStores(this.getStores());
        // основные виджеты
...
var ComDesc = __webpack_require__(14);
/**
...
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(3);
var BaseWidget_1 = __webpack_require__(16);
var MainControlPanel_1 = __webpack_require__(17);
var LogPanel_1 = __webpack_require__(18);
/**
...
var MainAppWidget = (function (_super) {
    ...
    function MainAppWidget(place) {
        ...
        _this._place.appendChild(_this._mainDiv);
        _this._ctrlDiv = document.createElement('div');
        _this._place.appendChild(_this._ctrlDiv);
        _this._logDiv = document.createElement('div');
        _this._place.appendChild(_this._logDiv);
        return _this;
    }
    MainAppWidget.prototype.draw = function () {
        ReactDOM.render(React.createElement(LogPanel_1.LogPanel, null), this._mainDiv);
        ReactDOM.render(React.createElement(MainControlPanel_1.MainControlPanel, { title: "not" }), this._ctrlDiv);
 ...
 */
var MainControlPanel = (function (_super) {
    __extends(MainControlPanel, _super);
    function MainControlPanel(props) {
        return _super.call(this, props, []) || this;
    }
    // Интересующие нас состояния (получаем их строго из Сторов)
    MainControlPanel.prototype.getState = function () {
        return {};
    };
    ///
    /// User interactions
    ///
    MainControlPanel.prototype.onButtonAdd = function () {
        //Actions.addItem({t:'bebebeee'});
        this.getActionCreator().addItem({ t: 'bebebeee' });
    };
    MainControlPanel.prototype.onButtonDelete = function () {
    ...
    /// Render
    ///
    MainControlPanel.prototype.drawButtons = function () {
        var _this = this;
    ...
    MainControlPanel.prototype.render = function () {
        var buttons = this.drawButtons();
        return React.createElement("div", { className: "MainControlPanel", "data-p1": this.props.title }, buttons);
    };
    return MainControlPanel;
}(View_1.default));
exports.MainControlPanel = MainControlPanel;
...
Object.defineProperty(exports, "__esModule", { value: true });
var fbemitter_1 = __webpack_require__(20);
var Utils_1 = __webpack_require__(1);
